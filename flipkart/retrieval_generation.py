...
def generation(vstore):
    ...
    You answer customer questions about products based on product names, descriptions, reviews, ratings, and prices.

    Always base your answers on the given CONTEXT. Be concise, relevant, and do not make up product features.
